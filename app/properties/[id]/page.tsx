                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 py-8 border-y border-white/5 mb-8">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xl font-semibold">{property.squareFeet.toLocaleString()}</span>
                    </div>
                  </div>
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xl font-semibold capitalize">{property.propertyType}</span>
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-6">
            <Card className="bg-[#231e1b] border-white/10 shadow-2xl sticky top-24 overflow-hidden">
              ...
              <CardContent className="p-8">
                ...
                <LeadForm propertyId={property._id} trigger={
                ...
                <div className="mt-8 pt-8 border-t border-white/5 space-y-4 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-white/80 font-mono text-xs">{property._id.slice(-8).toUpperCase()}</span>
                  </div>
                  <div className="flex justify-between">
